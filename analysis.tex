...
In this section we will outline our efforts towards translating the requirements into a large scale organization of system namespaces, that is to say the logical architecture of the system. This is modelled using an UML package diagram, which will serve as the basis for the discussion in the following sections.
\subsection{Package Diagram}
The package diagram below reflects bla bla bla
\begin{center}
