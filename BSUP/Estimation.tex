...
This estimate, or median, is a better guess for how long a task will take to complete. But there is still a deviation. We here talk about the standard deviation, which we calculate as 
$\frac{worst-best}{6}$
